...
/**
 * التذييل — تذييل شامل بالروابط وأيقونات التواصل الاجتماعي ومعلومات الاتصال
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-white/60">
              عضو مجلس النواب المصري — ملتزم بخدمة الوطن والتنمية المجتمعية
              والتميز التشريعي.
            </p>
          </div>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider text-[var(--gold)] mb-4">
              روابط سريعة
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-[var(--gold)] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[var(--gold)] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" aria-label="فيسبوك" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-[var(--gold)] hover:text-[var(--navy)] transition-all duration-300">
              ...
              <a href="#" aria-label="تويتر" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-[var(--gold)] hover:text-[var(--navy)] transition-all duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="#" aria-label="انستغرام" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-[var(--gold)] hover:text-[var(--navy)] transition-all duration-300">
              ...
              <a href="#" aria-label="يوتيوب" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-[var(--gold)] hover:text-[var(--navy)] transition-all duration-300">
