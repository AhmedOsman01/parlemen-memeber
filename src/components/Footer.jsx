...
/**
 * التذييل المحسّن — تذييل شامل بالنشرة البريدية وإحصائيات سريعة
 * وروابط خدمات المواطنين ومعلومات الاتصال
 */
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--navy-dark)] text-white/80" role="contentinfo">
      ...
      {/* Newsletter section */}
      <div className="bg-[var(--navy)] border-b border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-lg font-bold text-white mb-1">ابقَ على اطلاع</h3>
              <p className="text-sm text-white/40">اشترك للحصول على آخر الأخبار والتحديثات البرلمانية.</p>
            </div>
            <form onSubmit={handleNewsletterSubmit} className="flex w-full sm:w-auto gap-2">
              {subscribed ? (
                <div className="flex items-center gap-2 text-[var(--success)] text-sm font-medium animate-fade-in">
                ...
                <>
                  <input
                    ...
                    className="flex-1 sm:w-64 px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white placeholder-white/30 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--gold)]/30 focus:border-[var(--gold)]/50 transition-all"
                    dir="ltr"
                    required
                  />
                  <button
                    type="submit"
                    className="px-5 py-2.5 rounded-lg bg-[var(--gold)] text-[var(--navy)] font-semibold text-sm transition-all duration-200 hover:bg-[var(--gold-light)] shrink-0"
                  >
                    اشترك
                  </button>
                </>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            {/* Quick stats */}
            <div className="flex items-center gap-4 mb-6 py-3 px-4 rounded-lg bg-white/5 border border-white/5">
              <div className="text-center">
                <p className="text-lg font-bold text-[var(--gold)]">٣٢٠+</p>
                <p className="text-[10px] text-white/30">مشكلة حُلَّت</p>
              </div>
              <div className="w-px h-8 bg-white/10" />
              <div className="text-center">
                <p className="text-lg font-bold text-[var(--gold)]">٥٠ ألف+</p>
                <p className="text-[10px] text-white/30">مواطن خُدِم</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://wa.me/201001234567" target="_blank" rel="noopener noreferrer" aria-label="واتساب" className="w-9 h-9 rounded-lg bg-[#25D366]/10 flex items-center justify-center text-[#25D366]/60 hover:bg-[#25D366]/20 hover:text-[#25D366] transition-all duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "تقديم شكوى", href: "/services" },
                { label: "طلب خدمة", href: "/services" },
                { label: "طلب لقاء", href: "/contact" },
                { label: "اقتراح تشريعي", href: "/contact" },
                { label: "اسأل النائب", href: "/contact" },
              ].map((service) => (
        ...
        <div className="mt-12 pt-8 border-t border-white/5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1">
              <div className="w-4 h-[3px] bg-[var(--egypt-red)] rounded-sm" />
              <div className="w-4 h-[3px] bg-white rounded-sm" />
              <div className="w-4 h-[3px] bg-[var(--egypt-black)] rounded-sm" />
              <span className="text-xs text-white/30 mr-2">عضو مجلس النواب المصري</span>
            </div>
          </div>
